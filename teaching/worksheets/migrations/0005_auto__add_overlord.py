...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Overlord'
        db.create_table(u'worksheets_overlord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_angry', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'worksheets', ['Overlord'])


    def backwards(self, orm):
        # Deleting model 'Overlord'
        db.delete_table(u'worksheets_overlord')
    ...
    models = {
        ...
        u'worksheets.overlord': {
            'Meta': {'object_name': 'Overlord'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_angry': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
